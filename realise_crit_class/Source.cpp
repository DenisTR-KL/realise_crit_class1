...
#include <time.h>//Время раз

#include <thread>//Потоки от с++
#include <chrono>//Время два
...
int main(int argc, char* args[])
{
	...
	cout << "Это приложение имеет следующий функционал. Если по адресу d:\\1\\json.json" << endl;
	cout << "хранится массив данных в формате  JSON, то оно сможет их считать и обработать!" << endl;
	...
	cout << "Если вы нажмете кнопку '3', то программа создаст 5 потоков, считывают данные из d:\\1\\json.json и сразу выводят их на экран" << endl;
